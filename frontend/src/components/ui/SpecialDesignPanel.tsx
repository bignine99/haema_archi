...
const SpecialDesignPanel = () => {
    return (
        <div className="h-full flex flex-col p-6 bg-[#f8fafc] overflow-y-auto custom-scrollbar font-sans relative">
            {/* Header */}
            <div className="flex justify-between items-center mb-6 shrink-0 z-10">
                <div>
                    ...
                    <p className="text-slate-500 text-sm mt-1 font-medium">
                        성진학교 엔지니어링 실증 및 30년 생애주기 시스템 마스터플랜 (V3.0 - AI Simulated)
                    </p>
                </div>
                <div className="flex gap-2">
                    <button className="px-5 py-2 text-sm font-bold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors shadow-sm shadow-blue-200">
                        기술 제안서(PDF) 추출
                    </button>
                </div>
            </div>
            ...
            <div className="flex-1 grid grid-cols-12 gap-5 pb-24 relative">
                ...
                <div className="col-span-12 bg-white rounded-xl border border-slate-200 p-0 shadow-sm flex flex-col md:flex-row overflow-hidden h-auto min-h-[220px]">
                    {/* Left: Core Identity */}
                    <div className="w-full md:w-3/12 p-6 flex flex-col justify-center border-r border-slate-100 bg-gradient-to-br from-white to-slate-50 relative">
                        ...
                        <h3 className="text-3xl font-extrabold text-slate-800 tracking-tight leading-tight mb-2">Weaving School</h3>
                        <p className="text-slate-400 font-bold mb-4 font-serif italic text-lg shadow-sm w-fit bg-white/50 px-1">엮어가는 배움의 공동체</p>
                        <p className="text-[11px] text-slate-600 leading-relaxed font-medium">
                            단순한 재활 기능을 넘어 지역과의 상생을 증명하며, 도심 속 메디컬 혁신 거점이자 생태적 숨통을 트는 **오아시스**로서 자리매김합니다.
                        </p>
                    </div>
                    ...
                    <div className="w-full md:w-3/12 p-5 grid grid-rows-3 gap-3 border-r border-slate-100">
                        ...
                        <div className="flex items-center gap-3 group">
                            <div className="w-10 h-10 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center shrink-0 shadow-sm border border-blue-100"><Network size={18} /></div>
                            <div>
                        ...
                        <div className="flex items-center gap-3 group">
                            <div className="w-10 h-10 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center shrink-0 shadow-sm border border-emerald-100"><Sparkles size={18} /></div>
                            <div>
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex items-end justify-between mb-2">
                                ...
                                <div className="flex-1 px-3 flex items-center justify-center relative">
                                    <div className="h-[1px] w-full bg-gradient-to-r from-slate-200 via-blue-500 to-emerald-500 absolute top-1/2"></div>
                                    <ArrowRight size={12} className="text-emerald-500 bg-white z-10 px-0.5 relative translate-y-[2px]" />
                                </div>
                                <div className="flex text-emerald-600 flex-col items-center gap-1"><Trees size={20} /><span className="text-[9px] font-bold">Green Oasis</span></div>
                            </div>
                            <div className="grid grid-cols-2 gap-2 mt-3">
                                <div className="bg-slate-50 rounded p-2 border border-slate-100">
                                    <div className="text-[8px] text-slate-500 mb-0.5 leading-tight">시각적 개방감<br/>(VSI Score)</div>
                                    <div className="text-base font-extrabold text-blue-600">+42<span className="text-[9px] text-blue-600">%</span></div>
                                </div>
                                <div className="bg-slate-50 rounded p-2 border border-slate-100">
                                    <div className="text-[8px] text-slate-500 mb-0.5 leading-tight">대지 내<br/>생태유입률</div>
                                    <div className="text-base font-extrabold text-emerald-600">16.7<span className="text-[9px] text-emerald-600">%</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full md:w-3/12 p-5 bg-indigo-50/50 text-slate-800 relative flex flex-col justify-center">
                        <Landmark className="absolute top-3 right-3 text-indigo-500/10" size={80} />
                        <div className="relative z-10">
                            <div className="flex items-center gap-1 mb-2">
                                <BadgeCheck size={14} className="text-indigo-600" />
                                <div className="text-[10px] font-bold text-indigo-700 tracking-wider">POLICY ALIGNMENT</div>
                            </div>
                            <h4 className="text-sm font-extrabold mb-1">제6차 특수교육 발전계획 완벽 부합</h4>
                            <p className="text-[9px] text-slate-500 mb-3 leading-relaxed">
                                교육부 주관 미래형 맞춤 특수교육 정책 방향성과 강력하게 연대하는 공익적 미래형 표준 모델.
                            </p>
                            <div className="flex flex-col gap-1.5">
                                <span className="bg-white border border-indigo-100 text-indigo-700 text-[9px] px-2 py-1 rounded shadow-sm">✔ 학생 맞춤형 특수교육환경 고도화</span>
                                <span className="bg-white border border-indigo-100 text-indigo-700 text-[9px] px-2 py-1 rounded shadow-sm">✔ 지역사회 상호작용 및 통합교육 거점</span>
                                <span className="bg-white border border-indigo-100 text-indigo-700 text-[9px] px-2 py-1 rounded shadow-sm">✔ 무장애(BF) 디지털 기반 스마트 안심학교</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-span-12 lg:col-span-5 bg-white rounded-xl border border-slate-200 p-5 shadow-sm flex flex-col">
                    <div className="flex items-center justify-between mx-1 mb-4">
                        <div>
                            <h3 className="text-sm font-bold text-slate-800 flex items-center gap-1.5">
                                <Network size={16} className="text-blue-600" /> Double Loops Architecture
                            </h3>
                            <p className="text-[10px] text-slate-500 mt-0.5 font-medium ml-5">학습과 치유의 입체적 동선 교차망</p>
                        </div>
                        <span className="text-[9px] bg-slate-800 text-white px-2 py-0.5 rounded font-bold uppercase tracking-wide flex items-center gap-1 shadow">
                            <Cpu size={10} className="text-blue-400" /> AI Flow Simulation
                        </span>
                    </div>
                    ...
                    <div className="flex-1 bg-slate-50 rounded-lg border border-slate-100 relative p-3 flex flex-col gap-3">
                        ...
                        <div className="h-[150px] bg-white rounded border border-slate-100 shadow-inner flex flex-col items-center justify-center relative overflow-hidden">
                            ...
                            <div className="absolute top-2 left-2 flex flex-col gap-1.5">
                                <div className="bg-slate-800/90 backdrop-blur border-l-2 border-l-blue-400 text-white px-2 py-1 flex items-center gap-1.5 rounded shadow-sm">
                                    <TrendingDown size={10} className="text-blue-400"/>
                                    <span className="text-[8px] font-bold">학생 피로도/관리 동선</span>
                                    <span className="text-[10px] font-black text-blue-400 ml-1">-15%</span>
                                </div>
                            </div>
                            <div className="absolute bottom-2 right-2 bg-white/95 backdrop-blur text-[9px] border border-blue-200 text-blue-700 px-2 flex items-center gap-1 py-1 rounded shadow-sm font-bold">
                                <Eye size={12} className="text-blue-600" /> HUB CPO 시야각 <span className="text-orange-500 font-black">160°</span> (무사각지대 0%)
                            </div>
                        </div>
                        ...
                        <div className="h-[130px] bg-white rounded border border-slate-200 p-3 relative flex items-center shadow-sm overflow-hidden">
                            ...
                            <div className="w-[45%] relative h-full border-r border-slate-200 pr-4 flex items-center bg-slate-50 rounded">
                                ...
                                <svg viewBox="0 0 100 80" className="w-full h-full drop-shadow-sm">
                                    ...
                                    <line x1="10" y1="10" x2="10" y2="70" stroke="#3b82f6" strokeWidth="1" />
                                    <polygon points="10,10 7,15 13,15" fill="#3b82f6" />
                                    <polygon points="10,70 7,65 13,65" fill="#3b82f6" />
                                    <text x="14" y="43" fill="#2563eb" fontSize="9" fontWeight="bold">3.3m</text>
                                    
                                    {/* Simulation Heatmap Blob */}
                                    <circle cx="55" cy="40" r="25" fill="none" stroke="#22c55e" strokeWidth="0.5" strokeDasharray="1 1" opacity="0.6"/>
                                    <rect x="30" y="20" width="30" height="18" rx="2" fill="#ffffff" stroke="#0ea5e9" />
                                    <circle cx="55" cy="29" r="6" fill="#0ea5e9" opacity="0.9" />
                                    <line x1="25" y1="20" x2="25" y2="38" stroke="#0ea5e9" strokeWidth="1.5" />
                            ...
                            <div className="w-[55%] pl-4 relative z-10">
                                <div className="text-[9px] text-blue-600 font-bold flex items-center justify-between mb-1 uppercase tracking-wider">
                                    <span className="flex items-center gap-1"><Cpu size={10} /> Bottleneck Analyzed</span>
                                    <span className="bg-emerald-50 text-emerald-600 px-1 py-0.5 rounded border border-emerald-200 tracking-widest text-[7px] font-black">PASS</span>
                                </div>
                ...
                <div className="col-span-12 lg:col-span-7 flex flex-col gap-5">
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm flex-1">
                        <div className="flex items-center justify-between mx-1 mb-3">
                            <h3 className="text-sm font-bold text-slate-800 flex items-center gap-1.5 flex-1">
                                <Activity size={16} className="text-emerald-500" /> 4단계 메디컬 재활 클러스터
                            </h3>
                            ...
                            <div className="flex bg-slate-50 border border-slate-200 rounded p-1 gap-1 shadow-inner h-fit">
                                <div className="text-[8px] font-bold bg-white text-slate-600 px-1 py-0.5 rounded shadow-sm">1F 유치원</div>
                                <div className="text-[8px] font-bold bg-white text-slate-600 px-1 py-0.5 rounded shadow-sm">2F 초등</div>
                                <div className="text-[8px] font-bold bg-white text-slate-600 px-1 py-0.5 rounded shadow-sm">3F 중등</div>
                                <div className="text-[8px] font-bold bg-amber-50 border border-amber-200 text-amber-700 px-1 py-0.5 rounded shadow-sm">4F 고등/전공과</div>
                            </div>
                        </div>
                        <div className="grid grid-cols-4 gap-3 relative before:absolute before:top-[50%] before:left-4 before:right-4 before:h-[2px] before:bg-slate-100 before:-z-10 h-[100px]">
                            {[ 
                                { step: 1, name: '재활운동', color: 'emerald', sub: '수중운동실(32℃), 보행훈련' },
                                { step: 2, name: '감각지각', color: 'emerald', sub: '감각통합실, 작업치료실' },
                                { step: 3, name: '생활적응', color: 'blue', sub: '가사교육(ADL), 모의체험존' },
                                { step: 4, name: '정서케어', color: 'orange', sub: '스누젤렌(Snoezelen), 언어치료' }
                            ].map((item, i) => (
                                <div key={i} className={
                                    ...
                                    (item.color === 'emerald' ? 'hover:border-emerald-400' : item.color === 'blue' ? 'hover:border-blue-400' : 'hover:border-orange-400')
                                    ...
                                    <div className="flex items-center gap-2 mb-1">
                                        <div className={
                                            ...
                                            (item.color === 'emerald' ? 'group-hover:bg-emerald-500' : item.color === 'blue' ? 'group-hover:bg-blue-500' : 'group-hover:bg-orange-500')
                                        }>{item.step}</div>
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm flex relative overflow-hidden">
                        ...
                        <div className="w-6/12 relative z-10 pr-5 border-r border-slate-100">
                            ...
                            <div className="flex flex-col gap-2">
                                <div className="bg-slate-50 p-2 rounded border border-slate-100 border-l-2 border-l-blue-500 flex items-start gap-2">
                                ...
                                <div className="bg-slate-50 p-2 rounded border border-slate-100 border-l-2 border-l-emerald-500 flex items-start gap-2">
                                    <Maximize2 size={12} className="text-emerald-500 shrink-0 mt-0.5" />
                                    <div>
                        ...
                        <div className="w-6/12 relative z-10 flex items-center justify-center pl-5">
                            <div className="w-full flex items-center justify-between bg-slate-50 border border-slate-200 p-3 rounded-lg shadow-sm relative overflow-hidden group">
                                ...
                                <svg viewBox="0 0 100 50" className="absolute inset-0 w-full h-full opacity-10 group-hover:opacity-20 transition-opacity">
                                    ...
                                    <rect x="52" y="0" width="48" height="50" fill="#22c55e" />
                                </svg>
                                <div className="relative z-10 text-center flex-1">
                                    <div className="text-[9px] text-blue-600 font-bold mb-0.5">학생 전용 구역</div>
                                ...
                                <div className="relative z-10 text-center flex-1">
                                    <div className="text-[9px] text-emerald-600 font-bold mb-0.5">주민 개방 구역</div>
                ...
                <div className="col-span-12 lg:col-span-6 bg-white rounded-xl border border-red-100 shadow-sm overflow-hidden flex flex-col relative">
                    ...
                    <div className="p-5 flex-1 flex flex-col">
                        ...
                        <div className="flex gap-4 flex-1">
                            ...
                            <div className="w-[55%] flex flex-col justify-center gap-2.5">
                                ...
                                <div className="border border-slate-100 rounded p-2 flex items-start gap-3 hover:bg-blue-50 transition-colors bg-white">
                                    <div className="p-1.5 bg-blue-50 text-blue-600 rounded mt-0.5"><Navigation size={14} /></div>
                                    <div>
                ...
                <div className="col-span-12 lg:col-span-6 bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex flex-col relative text-slate-600">
                    ...
                    <div className="p-5 flex-1 flex flex-col relative z-10 w-full h-full">
                        <div className="flex items-center justify-between mb-4">
                            <div>
                                <h3 className="text-sm font-bold text-slate-800 flex items-center gap-1.5">
                                    <Server size={16} className="text-blue-500" /> Digital Twin Facility Management
                                </h3>
                                <p className="text-[10px] text-slate-500 mt-0.5 ml-5 font-medium">IoT 기반 통합 관제 및 의료급 실내 공조망(HVAC) 제어</p>
                            </div>
                            <span className="bg-blue-50 text-blue-600 border border-blue-200 text-[9px] px-2 py-0.5 rounded shadow-sm font-black">24H MONITORING</span>
                        </div>
                        ...
                        <div className="flex-1 flex gap-4 mt-2">
                            ...
                            <div className="w-[50%] bg-slate-50/80 border border-slate-200 rounded-lg p-3 flex flex-col shadow-sm backdrop-blur-sm">
                                ...
                                <div className="grid grid-cols-2 gap-2 flex-1">
                                    ...
                                    <div className="bg-white rounded p-1.5 flex flex-col items-center justify-center border border-slate-200 shadow-sm">
                                        ...
                                        <div className="text-lg font-black text-blue-600">8<span className="text-[8px] text-slate-500 ml-0.5 font-normal">㎍/㎥</span></div>
                                        <span className="text-[7px] text-blue-700 bg-blue-50 border border-blue-100 px-1 mt-1 rounded">Excellent</span>
                                    </div>
                                    {/* CO2 */}
                                    <div className="bg-white rounded p-1.5 flex flex-col items-center justify-center border border-slate-200 shadow-sm">
                                        <span className="text-[8px] text-slate-500">이산화탄소 (CO2)</span>
                                        <div className="text-lg font-black text-emerald-600">420<span className="text-[8px] text-slate-500 ml-0.5 font-normal">ppm</span></div>
                                        <span className="text-[7px] text-emerald-700 bg-emerald-50 border border-emerald-100 px-1 mt-1 rounded">Normal</span>
                                    </div>
                                </div>
                                <div className="mt-2 w-full h-10 border border-slate-200 bg-white rounded overflow-hidden relative shadow-sm">
                                    <svg viewBox="0 0 100 40" className="w-full h-full opacity-50" preserveAspectRatio="none">
                                        <path d="M 0 30 Q 10 20 20 30 T 40 30 T 60 25 T 80 15 T 100 20 L 100 40 L 0 40 Z" fill="rgba(59,130,246,0.2)"/>
                                        <path d="M 0 30 Q 10 20 20 30 T 40 30 T 60 25 T 80 15 T 100 20" fill="none" stroke="#3b82f6" strokeWidth="1"/>
                                    </svg>
                            ...
                            <div className="w-[50%] flex flex-col justify-center gap-3">
                                <div className="flex items-start gap-2 bg-white p-2 rounded shadow-sm border border-slate-100">
                                    <Fan size={14} className="text-blue-500 shrink-0 mt-0.5" />
                                    <div>
                ...
                <div className="col-span-12 bg-white rounded-xl border border-slate-200 p-5 shadow-sm flex flex-col relative overflow-hidden">
                    <div className="flex items-center justify-between mx-1 mb-4 z-10 relative">
                        <div>
                            <h3 className="text-sm font-bold text-slate-800 flex items-center gap-1.5">
                                <Landmark size={16} className="text-emerald-600" /> BEMS 통합 에너지 자립 및 30년 LCC 경제성 분석
                            </h3>
                    ...
                    <div className="flex flex-col md:flex-row gap-5 z-10 relative">
                        ...
                        <div className="w-full md:w-3/12 flex flex-col gap-3 justify-center items-center px-4 border-r border-slate-100">
                            ...
                            <div className="w-full bg-slate-50 border border-slate-100 p-2 rounded text-center">
                                ...
                                <div className="text-lg font-black text-amber-500">40<span className="text-[10px] text-slate-400 ml-0.5">%</span> (125kW/y)</div>
                            </div>
                        </div>
                        ...
                        <div className="w-full md:w-9/12 flex gap-4 pr-2">
                            ...
                            <div className="w-[30%] flex flex-col gap-2 justify-center">
                                <div className="bg-emerald-50 border border-emerald-100 p-3 rounded-lg shadow-sm">
                                    <div className="text-[10px] font-bold text-emerald-800 mb-1">30년 누적 운영비(OPEX) 절감</div>
                                    <div className="text-2xl font-black text-emerald-600 tracking-tighter">-35<span className="text-sm font-bold text-emerald-500">%</span> <span className="text-[10px] text-slate-500 ml-1 tracking-normal hover:text-slate-700">(약 42억)</span></div>
                                ...
                                <div className="bg-white border border-slate-200 p-3 rounded-lg shadow-sm">
                                    ...
                                    <div className="text-lg font-black text-blue-600 tracking-tighter">7.4<span className="text-xs font-bold text-slate-500 ml-1 tracking-normal">Years (초기투자 회수)</span></div>
                                    <p className="text-[8px] text-slate-500 mt-1 leading-tight">특화설계에 따른 시공비 상승분은 준공 후 약 7.4년 내 운영비 절감으로 전액 회수완료 확보.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="absolute bottom-6 left-6 right-6 bg-slate-800 text-slate-300 rounded-lg p-3.5 shadow-2xl border border-slate-700 flex items-center justify-between pointer-events-none z-50">
                <div className="flex items-center gap-2 pr-4 border-r border-slate-600">
                    ...
                    <div>
                        <div className="text-[11px] font-black tracking-widest text-white leading-none mb-1">NINETYNINE TECH CERTIFIED</div>
                ...
                <div className="flex-1 flex justify-evenly text-[10px] font-medium px-2">
                    <div className="flex flex-col items-center gap-0.5"><span className="text-emerald-400 font-bold">10-Sim Tested</span><span>복도폭 3.3m 확보</span></div>
                    ...
                    <div className="w-[1px] h-6 bg-slate-700"></div>
                    <div className="flex flex-col items-center gap-0.5"><span className="text-blue-400 font-bold">30Y LCC Opt.</span><span>ZEB 4등급 (신재생 40%)</span></div>
                    <div className="w-[1px] h-6 bg-slate-700"></div>
                    ...
                    <div className="w-[1px] h-6 bg-slate-700"></div>
                    <div className="flex flex-col items-center gap-0.5"><span className="text-rose-400 font-bold">Barrier Free 100</span><span>BF 최우수 등급 만족</span></div>
                </div>
            </div>
        </div>
    );
...
const AxonometricDiagram = () => (
    <svg viewBox="0 0 300 150" className="w-[130%] h-[130%] transform translate-y-3 opacity-95 drop-shadow-lg scale-110">
        ...
        {/* Learning Loop (Blue) Isometric Track */}
        <path d="M 115 75 C 40 40, 40 130, 115 105 C 145 95, 140 65, 155 55" fill="none" stroke="#3b82f6" strokeWidth="8" opacity="0.25" />
        <path d="M 115 73 C 40 38, 40 128, 115 103 C 145 93, 140 63, 155 53" fill="none" stroke="#2563eb" strokeWidth="3" />
        <text x="50" y="50" fill="#1e40af" fontSize="9" fontWeight="bold">Play Street (2F)</text>
        ...
        {/* Care Loop (Green) Isometric Track */}
        <path d="M 185 85 C 260 55, 260 145, 185 115 C 155 105, 160 75, 145 65" fill="none" stroke="#22c55e" strokeWidth="8" opacity="0.25" />
        <path d="M 185 83 C 260 53, 260 143, 185 113 C 155 103, 160 73, 145 63" fill="none" stroke="#16a34a" strokeWidth="3" />
        <text x="210" y="115" fill="#14532d" fontSize="9" fontWeight="bold">Care Street (3F)</text>
...
const GaugeChart = ({ value }: { value: number }) => (
    <div className="relative w-28 h-28 shrink-0">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pt-2">
            <span className="text-[10px] font-bold text-emerald-600 uppercase mb-0.5">ZEB Grade</span>
...
const LCCChartDiagram = () => (
    <svg viewBox="0 0 400 150" className="w-full h-full">
        ...
        {/* Specialized Design Curve (Blue/Green, high CAPEX initially, flat OPEX) */}
        <path d="M 40 60 Q 150 70 360 85" fill="none" stroke="#22c55e" strokeWidth="3" />
        <text x="365" y="88" fill="#16a34a" fontSize="10" fontWeight="bold">특화 설계 (ZEB)</text>

        {/* Intersection Point */}
        <circle cx="140" cy="70" r="4" fill="#3b82f6" />
        <line x1="140" y1="70" x2="140" y2="110" stroke="#3b82f6" strokeWidth="1" strokeDasharray="2 2" />
        <text x="140" y="60" fill="#1d4ed8" fontSize="9" fontWeight="bold" textAnchor="middle">Crossover (초기투자비 회수)</text>

        {/* ROI Shaded Area (Profit) */}
        <path d="M 140 70 Q 250 80 360 85 L 360 20 Q 250 45 140 70 Z" fill="rgba(34,197,94,0.15)" />
        <text x="250" y="60" fill="#15803d" fontSize="12" fontWeight="black" textAnchor="middle">-35% OPEX 흑자 구간</text>
    </svg>
);
...
const HVACFlowDiagram = () => (
    <svg width="100%" height="100%" viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice">
        <g stroke="#3b82f6" strokeWidth="1.5" fill="none">
            ...
            <polygon points="260,95 250,100 260,105" fill="#38bdf8" />
            <text x="320" y="90" fill="#60a5fa" fontSize="10" strokeWidth="0">O.A (외기 도입)</text>

            {/* PRE-FILTER Block */}
            <rect x="200" y="75" width="50" height="50" stroke="#34d399" fill="rgba(52, 211, 153, 0.15)" strokeWidth="2" />
            <path d="M 210 75 L 210 125 M 225 75 L 225 125 M 240 75 L 240 125" stroke="#10b981" strokeDasharray="2" />
            <text x="205" y="140" fill="#34d399" fontSize="9" strokeWidth="0" fontWeight="bold">HEPA PRE-FILTER</text>
            ...
            <polygon points="10,95 0,100 10,105" fill="#38bdf8" />
            <text x="15" y="90" fill="#38bdf8" fontSize="10" strokeWidth="0" fontWeight="bold">S.A (클린 의료급기)</text>
        </g>
    </svg>
);
