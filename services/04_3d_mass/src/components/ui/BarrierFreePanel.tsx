...
export default function BarrierFreePanel() {
    ...
    if (!bfChecklist) {
        return <div className="p-10 text-center text-slate-500">데이터를 로드하는 중입니다...</div>;
    }
                ...
                <div className="max-w-4xl mx-auto space-y-6">
                    ...
                    <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 flex gap-3 text-blue-800">
                        ...
                        <div className="text-sm">
                            ...
                            <p className="opacity-90">특수학교 과업지시서에서 추출된 정성적 데이터를 기반으로 BF(무장애) 지표 및 거점 클러스터를 설정하고 시뮬레이션에 반영합니다. 현재 값은 전역 상태 스토어에 보존됩니다.</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                        ...
                        <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-[10px] text-slate-400">※ 통상 1/12 이하 적용, 특수학교는 1/18 권장</p>
                            </div>
